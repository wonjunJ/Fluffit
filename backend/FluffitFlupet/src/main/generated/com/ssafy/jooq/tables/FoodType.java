...
public class FoodType extends TableImpl<FoodTypeRecord> {
    ...
    /**
     * The reference instance of <code>flupet_service.food_type</code>
     */
    ...
    /**
     * The column <code>flupet_service.food_type.id</code>.
     */
    ...
    /**
     * The column <code>flupet_service.food_type.fullness_effect</code>.
     */
    ...
    /**
     * The column <code>flupet_service.food_type.health_effect</code>.
     */
    ...
    /**
     * Create an aliased <code>flupet_service.food_type</code> table reference
     */
    ...
    /**
     * Create a <code>flupet_service.food_type</code> table reference
     */
    public FoodType() {
     ...
     */
    public <U> SelectField<U> mapping(Function7<? super UInteger, ? super String, ? super String, ? super Integer, ? super Integer, ? super Integer, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function7<? super UInteger, ? super String, ? super String, ? super Integer, ? super Integer, ? super Integer, ? super String, ? extends U> from) {
