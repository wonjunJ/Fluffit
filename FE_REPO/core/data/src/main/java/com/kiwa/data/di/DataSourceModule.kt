...
import com.kiwa.data.datasource.BattleRecordDataSourceImpl
...
abstract class DataSourceModule {
    ...
    @Binds
    @Singleton
    abstract fun bindBattleRecordDataSource(battleRecordDataSourceImpl: BattleRecordDataSourceImpl):
