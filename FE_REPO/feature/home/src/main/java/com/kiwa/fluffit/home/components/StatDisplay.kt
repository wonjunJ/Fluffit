...
private fun StatDisplay(
    @DrawableRes statIconImage: Int,
    @DrawableRes statProgressImage: Int
) {
...
internal fun FullnessDisplay(stat: Int) {
    val image = when (stat) {
        ...
        in 81..100 -> R.drawable.fullness_100
        else -> R.drawable.fullness_0
    }
...
internal fun HealthDisplay(stat: Int) {
    val image = when (stat) {
        ...
        in 81..100 -> R.drawable.health_100
        else -> R.drawable.health_0
    }
